...
define( function( require , exports , model ){
    ...
    Observable.prototype = {
        ...
        addOnceListener: function(type , fn , scope , o){
            o = o || {};
            o.once = true;
            this.addListener(type , fn , scope , o);
        },
    ...
    Event.prototype = {
        ...
        fire: function(){
            ...
            for (var i = 0; i < len; i++){
                var l = ls[i]
                try{
                    if(!l.options.disabled && l.fn.apply(l.scope || this.obj || window,args) === false){
                        this.firing = false;
                        return false;
                    }
                    if(l.options.once){
