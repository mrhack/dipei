...
yum install vim nginx12 cpan php54w php54w-devel php54-pear mongo-10gen mongo-10gen-server php54w-fpm ImageMagick.x86_64 ImageMagick-devel.x86_64 gd.x86_64 gd-devel.x86_64 php54w-gd.x86_64 php54w-mbstring.x86_64 p7zip.x86_64 -v -y --skip-broken >initsh.log
