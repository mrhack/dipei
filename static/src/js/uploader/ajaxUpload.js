...
(function() {
    ...
    function addClass(ele, cls) {
        if (!hasClass(ele, cls)) {
            var c = ele.className;
            ele.className += ( c[c.length-1] != ' ' ) ? (' '+cls) : cls;
        }
    }
    ...
    Ajax_upload = AjaxUpload = function(button, options) {
        ...
        this._parentDialog = options.parent || d.body;
    ...
    AjaxUpload.prototype = {
        ...
        _rerouteClicks : function() {
            ...
            addEvent(document, 'mousemove', function(e) {
                ...
                if (self._disabled) {
                    removeClass(self._button, self._settings.hoverClass || 'hover');
                ...
                if ((c.x >= box.left) && (c.x <= box.right)
                    ...
                    addClass(self._button, self._settings.hoverClass || 'hover');
         ...
         */
        _createIframe : function(frameId) {
            // unique name
            // We cannot use getTime, because it sometimes return
            // same value in safari :(
            var id = frameId ? frameId : getUID();
        ...
        submit : function() {
            ...
            // execute user event
            var newId = getUID();
            if (!(settings.onSubmit.call(this, file, getExt(file), newId) == false)) {
                // Create new iframe for this submission
                var iframe = this._createIframe(newId);
                ...
                addEvent(
                        ...
                        function(e) {
                            ...
                            // FIXBUG : when upload image success , it has to sync file to servers. So delay 500ms to waite for server sync.
                            setTimeout(function(){
                                settings.onComplete.call(self, file, response, iframe.id);
                            } , 500);
        ...
        _createForm : function(iframe) {
            ...
            var form = toElement('<form method="post" enctype="multipart/form-data"><input type=hidden name="MAX_FILE_SIZE" value="5000000"></form>');
